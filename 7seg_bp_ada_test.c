...
int main() {
	...
	char digits[5]="";
        int ival = 630;
	sprintf(digits,"%04d",ival);
printf("%s\n",digits);
	HT16K33_UPDATE_DIGIT(&led_backpack1, 0, digits[0] , 0);
	HT16K33_UPDATE_DIGIT(&led_backpack1, 1, digits[1] , 0);
	HT16K33_UPDATE_DIGIT(&led_backpack1, 2, HT16K33_COLON_OFF, 0);
	HT16K33_UPDATE_DIGIT(&led_backpack1, 3, digits[2], 0);
	HT16K33_UPDATE_DIGIT(&led_backpack1, 4, digits[3], 0);
	...
	*/
	...
	HT16K33_SAY_COOL(&led_backpack1);5t5
	*/
